...
namespace Dupes_Cuisine.Food
{
    public class Food_JellyDoughnut : IEntityConfig
    {
        ...
        {
            GameObject food = EntityTemplates.ExtendEntityToFood(EntityTemplates.CreateLooseEntity("JellyDoughnut", Food_JellyDoughnut.Name, Food_JellyDoughnut.Description, 1f, false, Assets.GetAnim((HashedString)"food_jellydoughnut_kanim"), "object", Grid.SceneLayer.Front, EntityTemplates.CollisionShape.RECTANGLE, 0.8f, 0.4f, true), new EdiblesManager.FoodInfo("JellyDoughnut", 2800000f, 2, 255.15f, 277.15f, 2400f, true, DlcManager.EXPANSION1));
